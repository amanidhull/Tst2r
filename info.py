...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://testme04161:QRjv15ECzbfA6wE4@cluster0.b005w.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002421781174')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002421781174'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002421781174'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-4604331044'))
request_channel = environ.get('REQUEST_CHANNEL', '-4604331044') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002421781174')) # 
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/mslanders/2")
